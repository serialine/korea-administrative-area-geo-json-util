 ...
 */
var is3DPosition = function (coordinates) {
 ...
 */
var cloneMultiPolygons = function (features) {
    return features.map(function (feature) { return clone_1.default(feature); });
};
exports.cloneMultiPolygons = cloneMultiPolygons;
/**
 * 주어진 geojson을 포함하는 boundbox의 coordinate 배열을 반환합니다.
 */
var getBboxCoordinates = function (geoJson) {
 ...
 */
var getCircleBboxCoordinates = function (center, radiusInMeter) {
    var feature = circle_1.default([center.lng, center.lat], radiusInMeter, {
        units: "meters",
    });
